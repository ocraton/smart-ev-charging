...
- **`frontend-ui`** — User interface built with **Vue.js**, served by Nginx, that lets you visually test both flows (parallel orchestration and asynchronous simulation) by talking exclusively to the API Gateway.
